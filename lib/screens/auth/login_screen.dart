...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _submit() async {
    ...
    // ✅ Ne rien faire si succès - AuthWrapper va automatiquement rebuild
    // et afficher HomeScreen quand il détectera auth.isAuthenticated = true
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: ClipOval(
                    child: Image.asset(
                      'lib/assets/images/Lucky_day_logo.png',
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
                ...
                TextButton(
                  onPressed: () {
                    // ✅ Navigation vers RegisterScreen sans route nommée
                    Navigator.push(
                      context,
